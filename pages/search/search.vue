<template>
	<view>
		<navHeader navName="搜索" :index="true"></navHeader>
...
<script>
	...
	// 引入API
	import { getSearchHot,getSearchWord,getSearchSuggest } from '@/common/api.js'
	export default {
		data() {
			return {
				searchHot : [],
		...
		methods: {
			...
			handleToDetail(songId){
				uni.navigateTo({
					url: '/pages/musicDetail/musicDetail?songId='+songId
				});
			}
		},		
		components:{
